...
export function TabItem({value, title, isSelected = false}: TabItemProps) {
  return (
    <Tabs.Trigger value={value} className='px-1 pb-4 text-sm font-medium text-zinc-500 hover:text-violet-700 relative data-[state=active]:text-violet-800 outline-none group dark:text-zinc-400 dark:data-[state=active]:text-violet-300 dark:hover:text-violet-300'>
