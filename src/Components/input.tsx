...
export function InputControl(props: InputControlProps){
  return <input className='flex-1 border-0 bg-transparent p-0 outline-none text-zinc-900 placeholder-zinc-600 dark:placeholder:zinc-400 dark:text-zinc-100' {...props}/>
}
